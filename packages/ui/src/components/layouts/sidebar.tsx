...
import { useIsMobile } from "@spaceorder/ui/hooks/use-mobile";
...
import {
  ...
  TooltipProvider,
  TooltipTrigger,
} from "@spaceorder/ui/components/forms/tooltip";
  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "fixed h-[calc(100vh-56px)] z-10 w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex",
            side === "left"
