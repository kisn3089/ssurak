...
- **같은 테이블 간의 주문 맥락 실시간 공유**: 동일한 테이블을 공유하는 고객끼리 같은 장바구니와 주문 내용을 실시간으로 공유
...
**동일한 테이블 고객 간의 장바구니 및 주문 공유:** 같은 테이블을 공유하는 고객끼리 동일한 장바구니와 주문 내용을 실시간으로 공유하여, 여러 디바이스에서 함께 주문을 구성할 수 있습니다.
